...
class ReportGeneratorApp:
	def __init__(self, root):
		...
		self.root.geometry("700x175")
		self.root.minsize(500, 175)
		self.root.maxsize(900, 175)
		...
		# Output Directory
		tk.Label(root, text="Folderul pentru salavare:").grid(row=2, column=0, padx=5, pady=5, sticky="e")
		...
		self.generate_button.grid(row=4, column=0, columnspan=3, pady=10, padx=10, sticky="ew")
	...
	def generate_report(self):
		...
		try:
			...
			motion_report_exporter.export_pdf(report, report_name, output_directory)
			motion_report_exporter.export_xlsx(report, report_name, output_directory)
